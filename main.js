...
quick_draw_data_set_chosen_item = quick_draw_data_set[random_no];

console.log("Item:  "+quick_draw_data_set_chosen_item);

sketch = quick_draw_data_set_chosen_item;

document.getElementById("sketch_to_be_drawn").innerHTML = "The Sketch You Are Going To Draw:  " + sketch;
